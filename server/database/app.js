...
try {
    // Fetch all dealerships from the Dealerships collection
    const dealerships = await Dealerships.find();
    
    // Return the dealerships as JSON
...
try {
    ...
    // Fetch dealerships in the specified state from the Dealerships collection
